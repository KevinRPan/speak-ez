 ...
 * Direct port from js/data/interview-questions.js
 */
...
export function getQuestions(fieldKey: string, roundKey: string, level: string): Question[] {
  return FIELDS[fieldKey]?.rounds?.[roundKey]?.questions?.[level] || [];
}

export function getRandomQuestion(fieldKey: string, roundKey: string, level: string): Question | null {
