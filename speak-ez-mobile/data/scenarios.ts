 ...
 * Direct port from js/data/scenarios.js
 */
...
export type ScenarioCategory = (typeof SCENARIO_CATEGORIES)[keyof typeof SCENARIO_CATEGORIES];
...
export const SCENARIO_CATEGORY_INFO: Record<ScenarioCategory, ScenarioCategoryInfo> = {
...
export function getScenariosByCategory(category: ScenarioCategory): Scenario[] {
  return scenarios.filter(s => s.category === category).sort((a, b) => a.order - b.order);
}
